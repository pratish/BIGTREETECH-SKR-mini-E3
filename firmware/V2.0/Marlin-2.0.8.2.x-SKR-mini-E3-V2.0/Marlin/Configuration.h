...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, Ender-3 Pro Also)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "I create shit"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -34, 0 }
